  ...
  <body>
    <div class="main-block">
      ...
      <form action="createtask" method="post">
        ...
        <div class="info">
         <label for="proj">Choose a project</label>
...
{
	String variable="pro"+Integer.toString(i);
%>
...
<br><br>
         <label for="user">Choose a resource:</label>
...
%>
 ...
 <br/>
        ...
        <p>Task Name</p>
        <div>
          <textarea name="tname" rows="4"></textarea>
        </div>
        
          
        <p>Task Description</p>
        <div>
          <textarea name="tdes" rows="4"></textarea>
        </div>
        </div>
